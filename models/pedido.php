...
class Pedido
{
    ...
    {
        $sql = "SELECT p.*, u.nombre, u.apellido, u.email FROM pedidos p
                INNER JOIN usuarios u ON p.usuario_id = u.id  
                WHERE p.id = {$this->getId()}";
        $pedido = $this->db->query($sql);
        
        return $pedido->fetch_object(); //lo devuelve como un objeto utilizable desde aqui
    }
    ...
    public function getProdByPedido($id){
    ...
    public function saveLineaPedido(){
        $sql = "SELECT LAST_INSERT_ID() as 'pedido';";//devuelve el indice del ultimo pedido ingresado
